...
answer = 0
num 변수의 일의 자리 숫자를 answer 변수에 더하고, num 변수에서 일의 자리 숫자를 제거

answer += num % 10 : answer = 7
num /= 10 : num = 98
num 변수의 십의 자리 숫자를 answer 변수에 더하고, num 변수에서 십의 자리 숫자를 제거

answer += num % 10 : answer = 7 + 8 = 15
num /= 10 : num = 9
num 변수의 백의 자리 숫자를 answer 변수에 더하고, num 변수에서 백의 자리 숫자를 제거

answer += num % 10 : answer = 15 + 9 = 24
num /= 10 : num = 0
num 변수가 0이므로, 반복문을 종료
